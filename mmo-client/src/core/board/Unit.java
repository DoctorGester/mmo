...
public class Unit {
	...
	public Unit(CardMaster owner, UnitData unitData, Cell position){
		setOwner(owner);
	...
	private void loadSpells(){
		...
		for(String id: unitData.getSpells()){
			...
			spells.add(new Spell(data, this, board));
		}
	}
	...
	private void loadPassives(){
		...
		for (String id: unitData.getPassives()){
			...
			Passive passive = new Passive(data, this, board);
			passives.add(passive);
			passive.update();
		}
	}

	public TurnResults calculateTurnParameters(){
		TurnResults results = new TurnResults(this, damageDealt, healDone);
	...
	public void swapPositionWith(Unit unit){
