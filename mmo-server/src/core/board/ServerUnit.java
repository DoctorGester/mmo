...
public class ServerUnit implements Unit {
	...
	public ServerUnit(CardMaster owner, UnitData unitData, Cell position){
		setOwner(owner);
	...
	private void loadPassives(){
		...
		for(String id: unitData.getPassives()){
			...
			ServerPassive passive = new ServerPassive(data, this, board);
