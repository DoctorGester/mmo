...
public class ServerBuff implements Buff {
	...
	public ServerBuff(Board board, BuffData buffData, int timesToRepeat, int period, int initialDelay, Object data) {
		this.board = board;
	...
	public ServerBuff(Board board, BuffData buffData, int timesToRepeat, int period, Object data){
		this(board, buffData, timesToRepeat, period, period, data);
	}

	public ServerBuff(Board board, BuffData buffData, int timesToRepeat, int period){
