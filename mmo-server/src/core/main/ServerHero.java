...
public class ServerHero implements Hero {
	...
	public ServerHero(CardMaster owner){
	...
	private boolean checkCircleLineIntersection(Vector2 lstart, Vector2 lend, Vector2 center, float radius) {
    ...
    private boolean checkIntersection(float x, float y){
        List<ServerCardMaster> close = program.getClusterGrid().getHeroesInRadiusOf(owner, physicalSize * 2);
        for(ServerCardMaster cardMaster: close){
